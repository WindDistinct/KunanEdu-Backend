...
const { listar,actualizar ,eliminar,insertar,listarTodo,listarAuditoria,reporteAsistencia,obtenerPorFechaYCurso,crearMultiples} = require("../controllers/asistencia");
