...
const { listado, actualizar, eliminar, insertar, listarTodo, listarNotasCurso, listarNotasBimestre, crearMultiples, listarAuditoria, listarNotasAlumno, listarExamenes } = require("../controllers/examen");
...
router.get("/examen-curso/:curso_seccion/:bimestre", listarExamenes);
